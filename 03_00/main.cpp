		...
		if (ImGui::BeginTabItem("Objects")) {
			...
			if (ImGui::BeginTabBar("TABBER_OBJECTS"))
			{
				if (ImGui::BeginTabItem("Bezier"))
				{
					...
					ImGui::PushID("BEZIER_TRANSFORM");
					ImGui::Text("ControlPoint");
					ImGui::DragFloat3("01", &controlPoint[0].x, 0.01f);
					ImGui::Spacing();
					ImGui::DragFloat3("02", &controlPoint[1].x, 0.01f);
					ImGui::Spacing();
					ImGui::DragFloat3("03", &controlPoint[2].x, 0.01f);
					ImGui::Spacing();
					ImGui::PopID();
