...
void DrawBezier(const Vector3& _controlPoint0, const Vector3& _controlPoint1, const Vector3& _controlPoint2, 
	const Matrix4x4& _viewProjectionMatrix, const Matrix4x4& _viewportMatrix, uint32_t _color);
